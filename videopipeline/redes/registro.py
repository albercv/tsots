...
Guarda plataforma, fecha, url, proveedor y modo. Nunca la clave.
"""
...
def anotar(video: Path, plataforma: Plataforma, url: str = "", proveedor: str = "",
    ...
    contenido = {
        "version": VERSION,
        "publicaciones": [
            {**asdict(e), "plataforma": e.plataforma.value} for e in entradas
        ],
    }
